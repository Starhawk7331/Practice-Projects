...
YELLOW_SPACESHIP_IMAGE = pygame.image.load(
    os.path.join("Python\Games\Assets\spaceship_yellow.png")
)
...
RED_SPACESHIP_IMAGE = pygame.image.load(
    os.path.join("Python\Games\Assets\spaceship_red.png")
)
...
SPACE = pygame.transform.scale(
    pygame.image.load(os.path.join("Python\Games\Assets\space.png")), (WIDTH, HEIGHT)
)
